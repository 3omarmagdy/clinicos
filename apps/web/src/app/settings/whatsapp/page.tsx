...
type Summary = { configured: boolean; phoneNumberId?: string; appointmentTemplate?: string; marketingTemplate?: string | null; templateLanguage?: string; apiVersion?: string; enabled?: boolean };

type FormState = { phoneNumberId: string; accessToken: string; appSecret: string; webhookVerifyToken: string; apiVersion: string; appointmentTemplate: string; marketingTemplate: string; templateLanguage: string; enabled: boolean };

const blank: FormState = { phoneNumberId: '', accessToken: '', appSecret: '', webhookVerifyToken: '', apiVersion: 'v26.0', appointmentTemplate: 'clinic_appointment_reminder', marketingTemplate: 'clinic_offer_v1', templateLanguage: 'ar', enabled: false };
...
export default function WhatsAppSettingsPage() {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setForm((current) => ({ ...current, accessToken: '', appSecret: '', webhookVerifyToken: '' }));
