...
const roleCopy: Record<string, { title: string; description: string }> = {
  receptionist: { title: 'استقبال اليوم', description: 'ابدأ بتسجيل مريض جديد أو ابحث عن ملفه ثم راجع المواعيد.' },
  doctor: { title: 'عيادتك اليوم', description: 'راجع مواعيد اليوم ثم افتح ملف المريض عند بدء الكشف.' },
