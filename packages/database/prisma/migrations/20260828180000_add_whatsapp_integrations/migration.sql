CREATE TABLE "whatsapp_integrations" (
    ...
    "webhookVerifyTokenHash" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "whatsapp_integrations_webhookVerifyTokenHash_key" ON "whatsapp_integrations"("webhookVerifyTokenHash");
